...
export const ProjectSchema = z.object({
    ...
    inputsBusinessPlan: BusinessPlanInputsSchema.optional().nullable(),
    inputsBusinessPlanRealises: BusinessPlanInputsSchema.optional().nullable(),
    resultsBusinessPlan: BusinessPlanResultsSchema.optional().nullable(),
    resultsBusinessPlanRealises: BusinessPlanResultsSchema.optional().nullable(),
