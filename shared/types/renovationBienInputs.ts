...
// Schéma pour les inputs de rénovation
export const RenovationBienInputsSchema = z.object({
...
export type RenovationBienInputs = z.infer<typeof RenovationBienInputsSchema>; 